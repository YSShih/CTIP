...
public class ApiKeyFactory {
    ...
    public IssuedApiKey create(ApiKeyIssueRequest request, Set<String> systemPermissions, Set<String> granted) {
        ...
        ApiKeySnapshot snapshot = new ApiKeySnapshot(
                ...
                null,
                clock.now());
        return ApiKey.issue(snapshot, fullKey, systemPermissions, granted);
    }
}
