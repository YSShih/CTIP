...
> (currently through Phase 10 of 23: environment, Docker, Spring Boot bootstrap, database schema,
...
> STIX 2.1 projection & export, the anonymous read REST API with cursor pagination and
> unified error handling, and OpenAPI/Swagger documentation with a committed, drift-checked
> openapi.json).
>
...
這個 repository 包含**規格書與進行中的實作**（目前完成 Phase 1–10，共 23 個 phase；進度見
...
| 架構決策 | [`docs/architecture/decisions/`](docs/architecture/decisions/)（ADR 0001–0007：各 phase 的規格衝突處置與實作決策） |
