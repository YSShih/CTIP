...
> (currently through Phase 17 of 23 — **milestone M1 (MVP) complete**, M2 in progress: environment, Docker,
...
這個 repository 包含**規格書與進行中的實作**（目前完成 Phase 1–15 —— **里程碑 M1（MVP）完成**、M2 進行中，共 23 個 phase；進度見
