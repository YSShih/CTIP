...
> (currently through Phase 22 of 23 — **milestones M1 (MVP) and M2 (Platform) complete**, M3 in progress: environment, Docker,
...
> nightly index reconciliation job. M3 so far adds Kafka with WebSocket/SSE/webhook notifications,
...
> and OpenTelemetry tracing correlated with the traceId on every error response).
>
...
這個 repository 包含**規格書與進行中的實作**（目前完成 Phase 1–22 —— **里程碑 M1（MVP）與 M2（Platform）完成**、M3 進行中，共 23 個 phase；進度見
...
| 項目 | 狀態 |
|---|---|
| 規格書 | ✅ v2.0 完成（含 2026-08-21 / 2026-08-25 / 2026-08-26 / 2026-08-27 / 2026-08-28 / 2026-08-29 / 2026-08-30 **二十三輪**實作回饋修訂，見 [00 §0.7–§0.29](docs/spec/00-master.md)） |
